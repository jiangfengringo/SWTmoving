...
public class ModelAbsStraight {
	...
	public static void main(String[] args) {
		try {
			ModelAbsStraight window = new ModelAbsStraight();
			window.open();
		} catch (Exception e) {
			e.printStackTrace();
		}
			...
			public void mouseDown(MouseEvent arg0) {
				...
				new Thread(new Runnable() {
					...
					public void run() {
						// TODO Auto-generated method stub
						while(true){
							Model.absStraight(btn, btn0, display);
